!(function () {
  ...
  const x = [
    ...
    "./my-tasks/app.6439c8886a317a442098.js",
    ...
    "./my-tasks/runtime.ed04418207af187c683e.js",
    "./my-tasks/todo.91f9a6b8aca587d9191a.svg",
    "./my-tasks/manifest.ac324a6fb175e1f1dba2c678265b6dc2.webmanifest",
    "./my-tasks/offline.625f56b7a33e09dda5750503679fdf20.html",
  ];
  function R(e) {}
  function A(e, t, n) {
    return new Response(
  ...
  async function W(i, s, o) {
    ...
    if (d) {
      if (I(s) && !d.headers.get(a)) {
        ...
        try {
          let n = await d.text();
          E() && (n = n.replace(/<script id="tt"[\s\S]*?<\/script>/gi, ""));
    ...
    return (async function (i, s) {
      ...
      if (c.status === n) {
        ...
        I(i)
          ? ((e = await c.text()),
            d.set(a, L),
            E() && (e = e.replace(/<script id="tt"[\s\S]*?<\/script>/gi, "")))
          : (e = await c.blob()),
          (o = new Response(e, {
            headers: d,
            status: c.status,
  ...
  const D = "Категория",
    J = {
      icon_id: { validators: [[N, H(D, "icon_id")]], required: !0 },
      category_name: {
        validators: [[C(3, 20), U(D, "category_name", 3, 20)]],
        required: !0,
      },
    },
    K = (e) => P(e, J, Z, D);
  ...
  const M = {
      category_id: { validators: [[N, H(D, "category_id")]], required: !0 },
      ...J,
    },
    X = (e) => P(e, M, G, D);
  function B(e) {
  ...
  const V = "Задача",
    Y = {
      title: { validators: [[C(3, 100), U(V, "title", 3, 100)]], required: !0 },
      priority_id: { validators: [[N, H(V, "priority_id")]], required: !0 },
      category_id: {
        validators: [
          [
            B(N),
      ...
      description: {
        validators: [[B(C(3, 1e3)), U(V, "description", 3, 1e3)]],
      },
      due_date_time: {
        validators: [
          [
            ...
            `Свойство сущности ${V} "due_date_time" должно быть датой в формате ISO`,
          ],
        ],
      },
      deleted: { validators: [[B(z), F(V, "deleted")]] },
      completed: { validators: [[B(z), F(V, "completed")]] },
    },
    ee = (e) => P(e, Y, Q, V);
  function te(e) {
    const {
  ...
  const ne = {
      task_id: { validators: [[N, H(V, "task_id")]], required: !0 },
      ...Y,
    },
    re = (e) => P(e, ne, te, V);
  function ae(e, t, n) {
  ...
  async function oe(e) {
    ...
    return A(r, i.error.message, i.error.data);
  }
  async function ce(e) {
    const { request: t } = e,
      n = b(),
  ...
  (e.id = Date.now()),
    ...
    e.addEventListener("fetch", async function (t) {
      ...
      switch (n.method) {
        ...
        default:
          t.respondWith(A(-1, "Не допустимый http метод"));
      }
    }),
