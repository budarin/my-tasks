# Мои задачи AI+ ( постоянно обновляется ... )

Это винтажное <strong>PWA</strong> приложение, заботливо организующее ваш день, написанное на чистом вдохновении и представленное с помощью любовно разработанного интерфейса, использующего всю мощь искусственного интеллекта 💯.
